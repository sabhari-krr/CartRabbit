...
if (mysqli_stmt_error($statement) !== "") {
    ...
    while (mysqli_stmt_fetch($statement)) {
        ...
        echo "<div class='card-subtitle'>$room_name</div>";
        echo "<div class='card-subtitle'>$address_line, $city, $state</div>";
        ...
        foreach ($facilitiesArray as $facility) {
            ...
            if (!empty($trimmedFacility)) {
                echo "<span class='badge badge-primary text-dark'>$trimmedFacility</span>";
            }
        }
        echo '</div>';
